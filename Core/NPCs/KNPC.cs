...
namespace KArpReborn.Core.NPCs
{
    public class KNPC : GlobalNPC
    {
        ...
        public override bool PreAI(NPC npc) {
            ...
            if (npccs == null) {
                KArpRebornMain.Mod.Logger.Warn("NPC " + npc.FullName + " does not have an NPCComponentSystem, aborting!");
                return true;
            }
        ...
        public override void ModifyHitPlayer(NPC npc, Player target, ref int damage, ref bool crit)
        {
            ...
            if (npccs == null)
            {
                KArpRebornMain.Mod.Logger.ErrorFormat("{} does not have an NPCComponentSystem attached!", npc.FullName);
                return;
            }
            ...
            if (c == null)
            {
                KArpRebornMain.Mod.Logger.ErrorFormat("{} does not have a KArpPlayer attached!", target.name);
                return;
            }
        ...
        public override void ModifyHitNPC(NPC npc, NPC target, ref int damage, ref float knockback, ref bool crit)
        {
            ...
            {
                KArpRebornMain.Mod.Logger.ErrorFormat("{} does not have an NPCComponentSystem attached!", target.FullName);
                return;
            }
        ...
        public override void NPCLoot(NPC npc)
        {
            ...
            if (npcct == null) {
                KArpRebornMain.Mod.Logger.Debug("No NPCCT available, aborting");
                return;
            }
            ...
            if (Main.netMode == NetmodeID.SinglePlayer && combatants.Length > 0)
            {
                ...
                {
                    KArpRebornMain.Mod.Logger.Debug("Awarding experience to " + player.name);
